...
class ColorPaletteLogic{
  ...
  factory ColorPaletteLogic.fromHue(double hue, {bool isDarkMode = false}){
    ...
    return ColorPaletteLogic(
      ...
      isColored: true,
      isDarkMode: false,
      primary: HSLColor.fromAHSL(1, hue, 0.97, 0.88).toColor(),
      secondary: HSLColor.fromAHSL(1, hue, 0.82, 0.76).toColor(),
  ...
  factory ColorPaletteLogic.asWhiteTheme(){
    return ColorPaletteLogic(
      ...
      isColored: false,
      isDarkMode: false,
      primary: HSLColor.fromAHSL(1, 0, 0, 0.88).toColor(),
      secondary: HSLColor.fromAHSL(1, 0, 0, 0.76).toColor(),
  ...
  factory ColorPaletteLogic.asBlackTheme(){
    return ColorPaletteLogic(
      ...
      // inactiveElementText: HSLColor.fromAHSL(1, 0, 0, 0.5).toColor(),
      // inactiveElementBorder: HSLColor.fromAHSL(0.9, 0, 0, 0.5).toColor(),
      primary: HSLColor.fromAHSL(1, 0, 0, 0.12).toColor(),
      secondary: HSLColor.fromAHSL(1, 0, 0, 0.28).toColor(),
      activeElementBackground: HSLColor.fromAHSL(1, 0, 0, 0.13).toColor(),
      activeElementText: HSLColor.fromAHSL(1, 0, 0, 0.78).toColor(),
      activeElementBorder: HSLColor.fromAHSL(0.85, 0, 0, 0.78).toColor(),
      inactiveElementBackground: HSLColor.fromAHSL(1, 0, 0, 0.18).toColor(),
      inactiveElementText: HSLColor.fromAHSL(1, 0, 0, 0.42).toColor(),
      inactiveElementBorder: HSLColor.fromAHSL(0.85, 0, 0, 0.42).toColor(),
    );
  }
